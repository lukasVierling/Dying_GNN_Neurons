...
def average_dict(dict,n):
    ...
    dict["test_0_output"] = dict["test_0_output"]/n
    return dict

def update_dict(dict, dead_neurons_tracker, val_accuracies, train_accuracies, test_acc, test_dead_neurons, test_0_output):
    ...
    dict["test_0_output"] = dict["test_0_output"] + test_0_output
    return dict
